...
//        TransactionDAO inMemoryTransactionDAO = new InMemoryTransactionDAO();
        TransactionDAO p_trans_DAO = new PersistentTransactionDAO(context);
        setTransactionsDAO(p_trans_DAO);

//        AccountDAO inMemoryAccountDAO = new InMemoryAccountDAO();
        AccountDAO p_ac_DAO = new PersistentAccountDAO(context);
        setAccountsDAO(p_ac_DAO);
